		...
		<form action="searchservlet" name="searchform" method="post" onsubmit="return on_submit();">
			<table width="1210" border="0" height="613">
				<tr>
					...
					<td width="480" align="right" class="text">
						<%=session.getAttribute("username")%>，您好！|<a href="Login.jsp"> 注销</a>
					</td>
				</tr>
				<tr>
					<td colspan="2">&nbsp;</td>
				...
				<tr>
					<td colspan="2">预测时间：
						<input type="text" name="forecastPeriod" id="forecastPeriod" /> &nbsp; h &nbsp;&nbsp;&nbsp;&nbsp;
