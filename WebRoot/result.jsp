...
<body onload="checkvalue()" style="background:#2F4F4F;color:white">
	<center>
		<form action="photoDay1_cid1servlet" name="form" method="post">
			<table width="1000" height="25" border="0" cellspacing="0"
				cellpadding="0">
				<tr>
					<td>统计结果</td>
				</tr>
			...
			<table width="1000" height="25" style="text-align:center" border="0"
				cellspacing="0" cellpadding="0">
				<tr>
					<td>
						<!-- <input type="submit" name="OK" class="button" id="OK" style="font-size:18px" value="维修后置0键"> -->
						<img style="width:80%" src="${pageContext.request.contextPath }/images/result/tjt.png">
					</td>
				</tr>
			</table>
		</form>
