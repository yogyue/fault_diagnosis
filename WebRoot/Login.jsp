...
<body onload="javascript:changeimg()">
	<center>
		<form action="logincheckservlet" name="loginform" method="post"
			onsubmit="return on_submit();">
			<table width="960" height="405" background="images/Login.jpg">
				<tr>
					<td align="center" class="title">风机故障预测软件<br>
					</td>
					<td class="title">&nbsp;</td>
				...
				<tr>
					...
					<td colspan="3"><input name="LoginName" id="UserName"
						size="30" maxlength="30" height="18" title="输入用户名" />
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td align="right" class="text">密 码：</td>
					<td colspan="3"><input name="Password" id="Password" size="30"
						maxlength="30" height="18" title="输入密码" type="password" />
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					...
					<td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
						type="submit" name="OK" class="button" id="OK" value="登录">
					</td>
